...
//  MathTools
//
//  Created by Richard Chien on 14-1-18.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    if (floor(NSFoundationVersionNumber) <= NSFoundationVersionNumber_iOS_6_1) {
        ...
        [[UINavigationBar appearance] setTintColor:MATHTOOLS_THEME_COLOR];
        [[UIToolbar appearance] setTintColor:MATHTOOLS_THEME_COLOR];
    }
    return YES;
}
